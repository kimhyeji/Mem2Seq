...
parser.add_argument('-bsz','--batch', help='Batch_size', required=False, default="30")
parser.add_argument('-lr','--learn', help='Learning Rate', required=False, default="0.001")
parser.add_argument('-dr','--drop', help='Drop Out', required=False, default="0.1")
parser.add_argument('-um','--unk_mask', help='mask out input token to UNK', required=False, default=1)
parser.add_argument('-layer','--layer', help='Layer Number', required=False, default=6)
